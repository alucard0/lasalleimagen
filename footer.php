...
?>
	<footer class="container-fluid">
		...
		<div class="row">
			<div class="container">
				<ul>
					...
					<li><a href="#">Trabaja en La Salle</a></li>
					<li><a href="#">Universidad Segura</a></li>
		...
		<div class="row bgGray">
			<div class="container">
				...
				<!--
				<div class="col-sm-12">
					<ul class="listaEscuelas">
						<li><a href="http://bajio.delasalle.edu.mx/">Bajio</a></li>
						<li><a href="http://lasallecancun.edu.mx/">Cancun</a></li>
						<li><a href="http://ulsachihuahua.edu.mx/">Chihuahua</a></li>
						<li><a href="http://www.ulsac.edu.mx/">Cuernavaca</a></li>
						<li><a href="http://www.ulsalaguna.edu.mx/">Laguna</a></li>
						<li><a href="http://www.ceslas.mx/">Monterrey</a></li>
						<li><a href="http://www.lasallemorelia.edu.mx/">Morelia</a></li>
						<li><a href="http://ulsaneza.edu.mx/">Nezahualcoyotl</a></li>
						<li><a href="http://www.ulsa-noroeste.edu.mx/">Noroeste</a></li>
						<li><a href="http://www.ulsaoaxaca.edu.mx/">Oaxaca</a></li>
						<li><a href="http://www.lasallep.edu.mx/ulsaweb/index.php/">Pachuca</a></li>
						<li><a href="http://www.universidadlasallebenavente.edu.mx/">Puebla</a></li>
						<li><a href="http://www.ulsasaltillo.edu.mx/">Saltillo</a></li>
						<li><a href="http://www.ulsavictoria.edu.mx/">Victoria</a></li>    
					</ul>
				</div>
				-->
			</div>
		...
		<div class="row bgWhite">
			<div class="container">
				...
				<div class="col-sm-12 resumenAviso">
					<p>
				...
				<div class="col-sm-12 resumenTerminos">
	...
	<script type="text/javascript" charset="utf-8"  src="controlador/descargable.min.js"></script>
</body>
</html>